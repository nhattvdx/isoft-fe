...
export class CompanyComponent implements OnInit {
    ...
    @ViewChild('companyForm') companyFormComponent:
    ...
    getbusinessTypeName(value) {
        let businessType = this.types.businessType.find(x => x.value === value);
        return businessType? businessType.label : '';
    }

    getAccordingAccountingRegimeName(value) {
        let accordingAccountingRegime = this.types.accordingAccountingRegime.find(x => x.value === value);
        return accordingAccountingRegime ? accordingAccountingRegime.label : '';
    }

    getMethodCalcExportPriceName(value) {
        let methodCalcExportPrice = this.types.methodCalcExportPrice.find(x => x.value === value);
