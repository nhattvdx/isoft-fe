...
export class TitleFormComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
      if (
          ...
          this.title = AppUtil.translate(this.translateService, 'label.edit_Position');
          ...
          this.title = AppUtil.translate(this.translateService, 'label.add_Position');
      }
  }
  ...
  onSubmit() {
      ...
      if (this.isEdit) {
          ...
          this.PositionService.createPosition(newData).subscribe((res) => {
              this.onCancel.emit({});
          });
      }
  }
