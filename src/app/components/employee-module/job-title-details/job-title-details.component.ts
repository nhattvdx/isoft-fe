...
export class JobTitleDetailsComponent implements OnInit {
    ...
    getPositionDetails(event?: any, isExport: boolean = false): void {
        ...
        this.pendingRequest = this.PositionDetailService
            .getListPositionDetail(this.getParams)
    ...
    getDetail(PositionDetailId) {
        this.PositionDetailService
            .getPositionDetailDetail(PositionDetailId)
    ...
    onDelete(PositionDetailId) {
        ...
        this.confirmationService.confirm({
            ...
            accept: () => {
                this.PositionDetailService
                    .deletePositionDetail(PositionDetailId)
