...
export class PositionDetailService {
    ...
    public getListPositionDetail(params: any): Observable<TypeData<PositionDetail>> {
    ...
    public createPositionDetail(PositionDetail: PositionDetail): Observable<PositionDetail | null> {
    ...
    public updatePositionDetail(PositionDetail: PositionDetail, id: number): Observable<PositionDetail> {
    ...
    getExcelReport(param: PageFilterPositionDetail): Observable<{ dt: string }> {
    ...
    importExcel(formData): Observable<any> {
        return this.httpClient.post(`${_prefix}/import-PositionDetail`, formData).pipe(
            map((data: any) => {
                return data;
            })
        );
