...
export class ContractTypeService {
    ...
    public getListContractType(params: any): Observable<TypeData<ContractType>> {
    ...
    public getAllContractType(): Observable<TypeData<ContractType>> {
    ...
    public createContractType(ContractType: ContractType): Observable<ContractType | null> {
    ...
    importExcel(formData): Observable<any> {
        return this.httpClient.post(`${_prefix}/import-ContractType`, formData).pipe(
            map((data: any) => {
                return data;
            })
        );
