...
export class DepartmentService {
    ...
    public getAllDepartment(): Observable<TypeData<Department>> {
    ...
    public createDepartment(Department: Department): Observable<Department | null> {
    ...
    importExcel(formData): Observable<any> {
        return this.httpClient.post(`${_prefix}/import-Department`, formData).pipe(
            map((data: any) => {
                return data;
            })
        );
